...
public class Test {
    ...
    public static void main(String [] args)
    {
        ...
        System.out.println("Eneter the value of number :");
        ...
        if(num%2==0)
        {
            ...
            if(num<0)
            {
                System.out.println("This number is nesitive number :");
            }
            else {
...
public class Test {
    public static void main(String[] args) {
        ...
        if(age=="child")
        {
            System.out.println("chiled prpice 20rs :");
        }
        else if(age=="adult")
        {
            System.out.println("adult price 50rs");
        }
        else if(age=="senior")
        {
            System.out.println("senior price 100rs");
        }
        else 
        {
